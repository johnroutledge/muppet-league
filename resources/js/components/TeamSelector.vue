        ...
        <div class="row">
                ...
                <div class="available-players">
                    ...
                    <ul>
                        <li v-for="player in filteredPlayers" @click="addToTeam(player)" 
                            ...
                            {{ player.first_name }} {{ player.surname }} {{ player.team_short_name }} ({{ player.position_short_name }}) £{{ player.price_pence / 10000000 }}m
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="selected-team">
                    ...
                    <ul>
                        <li v-for="player in selectedTeam" @click="removeFromTeam(player)">{{ player.first_name }} {{ player.surname }} {{ player.team_short_name }} ({{ player.position_short_name }})</li>
                    </ul>
                </div>
                <button @click="saveTeam" :disabled="isSaveButtonDisabled || isTeamNameEmpty || saving">Save</button>
            </div>
        </div>
    </div>
</template>
